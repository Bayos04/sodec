				...
				<div class="table-responsive">
					<table class="table search-table align-middle text-nowrap">
						...
						<tr class="search-items">
							...
							<td>
								<div class="d-flex align-items-center">
									<img src="src/public/images/profile/user-1.jpg" alt="avatar" class="rounded-circle" width="35" />
									<div class="ms-3">
						...
						<tr class="search-items">
							...
							<td>
								<div class="d-flex align-items-center">
									<img src="src/public/images/profile/user-2.jpg" alt="avatar" class="rounded-circle" width="35" />
									<div class="ms-3">
										<div class="user-meta-info">
						...
						<tr class="search-items">
							...
							<td>
								<div class="d-flex align-items-center">
									<img src="src/public/images/profile/user-3.jpg" alt="avatar" class="rounded-circle" width="35" />
									<div class="ms-3">
										<div class="user-meta-info">
						...
						<tr class="search-items">
							...
							<td>
								<div class="d-flex align-items-center">
									<img src="src/public/images/profile/user-4.jpg" alt="avatar" class="rounded-circle" width="35" />
									<div class="ms-3">
										<div class="user-meta-info">
						...
						<tr class="search-items">
							...
							<td>
								<div class="d-flex align-items-center">
									<img src="src/public/images/profile/user-5.jpg" alt="avatar" class="rounded-circle" width="35" />
									<div class="ms-3">
										<div class="user-meta-info">
