                    ...
                    <div class="min-width-340">
                        <div class="border-end user-chat-box h-100">
                            ...
                            <span class="position-relative">
                              <img src="src/public/images/profile/user-4.jpg" alt="user-4" width="40" height="40" class="rounded-circle">
                            </span>
                            ...
                            <span class="position-relative">
                              <img src="src/public/images/profile/user-4.jpg" alt="user4" width="40" height="40" class="rounded-circle">
                            </span>
                                            <div class="ms-6 d-inline-block w-75">
                            ...
                            <span class="position-relative">
                              <img src="src/public/images/profile/user-3.jpg" alt="user3" width="40" height="40" class="rounded-circle">
                            </span>
                                            <div class="ms-6 d-inline-block w-75">
                            ...
                            <span class="position-relative">
                              <img src="src/public/images/profile/user-8.jpg" alt="user8" width="40" height="40" class="rounded-circle">
                            </span>
                                            <div class="ms-6 d-inline-block w-75">
                            ...
                            <span class="position-relative">
                              <img src="src/public/images/profile/user-2.jpg" alt="user2" width="40" height="40" class="rounded-circle">
                            </span>
                                            <div class="ms-6 d-inline-block w-75">
                            ...
                            <span class="position-relative">
                              <img src="src/public/images/profile/user-1.jpg" alt="user1" width="40" height="40" class="rounded-circle">
                            </span>
                                            <div class="ms-6 d-inline-block w-75">
                                        ...
                                        <div class="position-relative">
                                            <div class="chat-box p-9" style="height: calc(100vh - 428px)" data-simplebar>
                                                <div class="chat-list chat active-chat" data-user-id="1">
                                                    <div class="hstack align-items-start mb-7 pb-1 align-items-center justify-content-between">
                                                        <div class="d-flex align-items-center gap-3">
                                                            <img src="src/public/images/profile/user-4.jpg" alt="user4" width="72" height="72" class="rounded-circle" />
                                                            <div>
                                                ...
                                                <div class="chat-list chat" data-user-id="3">
                                                    <div class="hstack align-items-start mb-7 pb-1 align-items-center justify-content-between">
                                                        <div class="d-flex align-items-center gap-3">
                                                            <img src="src/public/images/profile/user-3.jpg" alt="user3" width="72" height="72" class="rounded-circle" />
                                                            <div>
                                                ...
                                                <div class="chat-list chat" data-user-id="4">
                                                    <div class="hstack align-items-start mb-7 pb-1 align-items-center justify-content-between">
                                                        <div class="d-flex align-items-center gap-3">
                                                            <img src="src/public/images/profile/user-8.jpg" alt="user8" width="72" height="72" class="rounded-circle" />
                                                            <div>
                                                ...
                                                <div class="chat-list chat" data-user-id="5">
                                                    <div class="hstack align-items-start mb-7 pb-1 align-items-center justify-content-between">
                                                        <div class="d-flex align-items-center gap-3">
                                                            <img src="src/public/images/profile/user-2.jpg" alt="user2" width="72" height="72" class="rounded-circle" />
                                                            <div>
                                                ...
                                                <div class="chat-list chat" data-user-id="6">
                                                    <div class="hstack align-items-start mb-7 pb-1 align-items-center justify-content-between">
                                                        <div class="d-flex align-items-center gap-3">
                                                            <img src="src/public/images/profile/user-1.jpg" alt="user1" width="72" height="72" class="rounded-circle" />
                                                            <div>
